...
enum TaskTab { today, upcoming, completed }

class TasksBody extends StatefulWidget {
  final bool isTeacher;

  const TasksBody({super.key, required this.isTeacher});
...
class _TasksBodyState extends State<TasksBody> {
  ...
  void initState() {
    super.initState();
    // Initialize task list from mock data (mutable copy)
  ...
  String get _subtitle {
    ...
    switch (_selectedTab) {
      case TaskTab.today:
        return count == 0
            ? 'All caught up'
            : '$count task${count == 1 ? '' : 's'} for today';
      case TaskTab.upcoming:
        return count == 0
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 24),
              _buildTab(
                  'Completed', TaskTab.completed, _completedTasks.length),
            ],
          ),
        ),
        ...
        // Task list with Inline Add Button
        Expanded(
          child: tasks.isEmpty
              ? _buildEmptyState()
              : AnimatedSwitcher(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (index == tasks.length || tasks.isEmpty) {
                        return _selectedTab != TaskTab.completed
  ...
  Widget _buildInlineAddButton() {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: const Row(
          children: [
            Icon(Icons.add, color: AppColors.teal, size: 20),
            SizedBox(width: 12),
            Text(
              'Add new task...',
              style: TextStyle(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  ...
                  color: isSelected ? AppColors.deepNavy : AppColors.slateGray,
                ),
              ),
              if (count > 0) ...[
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              isCompleted ? 'No completed tasks' : 'No tasks yet',
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        if (!isDone) ...[
                          const SizedBox(width: 8),
                          _PriorityPill(task: task, isOverdue: isOverdue),
                        ],
                      ],
                    ),
                    const SizedBox(height: 8),
                    Row(
                      children: [
                        ...
                        const Icon(Icons.access_time,
                            size: 12, color: AppColors.slateGray),
